...
int Cfunc_route::user_add( const cli_proto_head_t& head, recv_data_cli_t& in, char** sendbuf, int& sndlen )
{
	user_add_in_t info;
...
int Cfunc_route::user_get_all( const cli_proto_head_t& head, recv_data_cli_t& in, char** sendbuf, int& sndlen )
{
